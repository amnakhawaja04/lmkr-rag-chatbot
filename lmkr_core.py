...
DATA_DIR = Path(r"C:\Users\afarooq\Desktop\lmkr\lmkr_data")
INDEX_DIR = Path(r"C:\Users\afarooq\Desktop\lmkr\faiss_lmkr")
...
rag_template = """ You are LMKR Assistant, a knowledgeable but concise AI assistant for LMKR.
